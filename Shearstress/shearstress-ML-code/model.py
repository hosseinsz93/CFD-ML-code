...
class ConvNet(nn.Module):
    def __init__(self):
        ...
        self.layer1 = nn.Sequential( 
                  nn.Conv2d(4, 8, kernel_size = (7,3), stride = (1,1), padding = (3,1),bias=False),
#                  nn.BatchNorm2d(8),
                  nn.LeakyReLU(0.1) )
#                  nn.BatchNorm2(8),

        self.layer2 = nn.Sequential(
                  nn.Conv2d(8, 16, kernel_size = (7,3), stride = (4,2), padding = (3,1),bias=False),
#                  nn.BatchNorm2d(16),
                  nn.LeakyReLU(0.1) )
#                  nn.BatchNorm2(16),
...
#                 nn.BatchNorm2(32),
        ...
        self.layer4 = nn.Sequential(
                  nn.Conv2d(32, 64, kernel_size = (9,3), stride = (5,2), padding = (4,1),bias=False),
#                  nn.BatchNorm2d(64),
                  nn.LeakyReLU(0.1) )
#                 nn.BatchNorm2(64),

        self.layer5 = nn.Sequential(
                  nn.ConvTranspose2d(64, 32, kernel_size = (9,4), stride = (5,2), padding = (2,1),bias=False),
#                  nn.BatchNorm2d(32),
                  nn.PReLU() )
#                 nn.BatchNorm3d(32),
...
#                  nn.BatchNorm3d(16),
        ...
        self.layer7 = nn.Sequential(
                  nn.ConvTranspose2d(16, 8, kernel_size = (6,4), stride = (4,2), padding = (1,1),bias=False),
#                  nn.BatchNorm2d(8),
                  nn.PReLU() )
#                  nn.BatchNorm3d(8),
